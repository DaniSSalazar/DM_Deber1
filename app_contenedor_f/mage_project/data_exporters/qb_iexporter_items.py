...
@data_exporter
def export_items_to_txt(data, **kwargs) -> None:
    """
    ...
    file_path = kwargs.get("file_path", "items.txt")
    ...
    with open(file_path, "w", encoding="utf-8") as f:
        while current_start < end_date:
            ...
            rows_in_range = [
                inv for inv in data
                if current_start.isoformat() <= inv.get("MetaData", {}).get("LastUpdatedTime", "") < current_end.isoformat()
            ]
